## Smoke test for the from-source ``qt6Multimedia`` recipe (M9.R.15q.10.5).
...
suite "qt6Multimedia — from-source recipe smoke test":
  ...
  test "runtime closure includes Qt, FFmpeg, and PulseAudio":
    check registeredRuntimeDeps("qt6Multimedia") == @[
      "qt6-base >=6.8",
      "qt6-declarative >=6.8",
      "ffmpeg >=7.1",
      "pulseaudio >=17.0",
