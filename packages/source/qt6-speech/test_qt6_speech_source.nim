## Smoke test for the from-source ``qt6Speech`` recipe (M9.R.15q.10.3).
...
suite "qt6Speech — from-source recipe smoke test":
  ...
  test "runtime closure includes the required Qt modules":
    check registeredRuntimeDeps("qt6Speech") == @[
      "qt6-base >=6.8",
      "qt6-declarative >=6.8",
      "qt6-multimedia >=6.8",
    ]
